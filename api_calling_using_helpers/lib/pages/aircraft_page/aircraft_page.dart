...
class AirCraftPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: controller.allAirCrafts.isEmpty
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "manufacturer :${controller.allAirCrafts[index].manufacturer}",
                        style: const TextStyle(
                          fontSize: 20,
                        ),
                      ),
                      Text(
                        "maxSpeedKnots :${controller.allAirCrafts[index].maxSpeedKnots}",
                        style: const TextStyle(fontSize: 20),
                        overflow: TextOverflow.ellipsis,
                        maxLines: 2,
                      ),
                      Text(
                        "grossWeightLbs :${controller.allAirCrafts[index].grossWeightLbs}",
                        style: const TextStyle(fontSize: 20),
                        overflow: TextOverflow.ellipsis,
                        maxLines: 2,
                      ),
                      Text(
                        "rangeNauticalMiles :${controller.allAirCrafts[index].rangeNauticalMiles}",
                        style: const TextStyle(fontSize: 20),
                        overflow: TextOverflow.ellipsis,
                        maxLines: 2,
                      ),
